...
DefineClass.MassClothingPrinter3D = {
	...
	display_name = T(393807551237, --[[ModItemBuildingCompositeDef MassClothingPrinter3D display_name]] "Clothing 3D Printer"),
	description = T(315551575679, --[[ModItemBuildingCompositeDef MassClothingPrinter3D description]] "Used for production of:\n - <color TextEmphasis>Summer clothing</color> x10<image 'UI/Icons/Items/tshirt' 1100>\n - <color TextEmphasis>Basic Weapons</color><image 'UI/Icons/Items/spear' 1100>\n - <color TextEmphasis>Advanced Weapons</color><image 'UI/Icons/Items/railgun_sniper_improved' 1100>"),
	BuildMenuIcon = "UI/Icons/Build Menu/3d_printer",
	BuildMenuPos = 14,
	display_name_pl = T(996185150295, --[[ModItemBuildingCompositeDef MassClothingPrinter3D display_name_pl]] "Clothing 3D Printer"),
	entity = "3D_Printer",
	labels = {
		"CPUCoreDevice",
		"BerserkTargets",
