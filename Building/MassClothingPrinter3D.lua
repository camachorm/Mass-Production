...
DefineClass.MassClothingPrinter3D = {
	...
	display_name = T(156683370292, --[[ModItemBuildingCompositeDef MassClothingPrinter3D display_name]] "Clothing 3D Printer"),
	description = T(696544104757, --[[ModItemBuildingCompositeDef MassClothingPrinter3D description]] "Used for production of:\n - <color TextEmphasis>Winter clothing</color> x10<image 'UI/Icons/Items/fur_coat' 1100>\n - <color TextEmphasis>Summer clothing</color> x10<image 'UI/Icons/Items/tshirt' 1100>\n - <color TextEmphasis>Mid-Season clothing</color> x10<image 'UI/Icons/Items/shirt_blue' 1100>"),
	BuildMenuIcon = "UI/Icons/Build Menu/3d_printer",
	BuildMenuPos = 14,
	display_name_pl = T(556837580272, --[[ModItemBuildingCompositeDef MassClothingPrinter3D display_name_pl]] "Clothing 3D Printer"),
	entity = "3D_Printer",
	labels = {
		"CPUCoreDevice",
		"BerserkTargets",
