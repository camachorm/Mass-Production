...
DefineClass.FarmField_MassPrint_GE_ChitinMeat = {
	...
	display_name = T(263609108103, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_ChitinMeat display_name]] "GE Chitin Meat field"),
	menu_display_name = T(782554508526, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_ChitinMeat menu_display_name]] "GE Chitin Meat"),
	BuildMenuIcon = "UI/Icons/Items/raw_meat_insect",
	BuildMenuPos = 32,
	display_name_pl = T(531842705947, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_ChitinMeat display_name_pl]] "GE Chitin Meat fields"),
