...
DefineClass.MassPrint_MotionSensor_Smart = {
	...
	display_name = T(663856420286, --[[ModItemBuildingCompositeDef MassPrint_MotionSensor_Smart display_name]] "Smart Motion sensor"),
	description = T(469063406398, --[[ModItemBuildingCompositeDef MassPrint_MotionSensor_Smart description]] "Adding a built-in CPU, basic AI algorithms and using better building materials to optimize the motion sensor, you get increased range and durability\n\nRange increase: <color TextEmphasis>1.5x</color>\nActivates when there are hostile animals in range."),
	menu_display_name = T(640081238666, --[[ModItemBuildingCompositeDef MassPrint_MotionSensor_Smart menu_display_name]] "Smart Motion Sensor"),
	BuildMenuIcon = "UI/Icons/Build Menu/infrared_detector",
	BuildMenuPos = 99,
	display_name_pl = T(954325040193, --[[ModItemBuildingCompositeDef MassPrint_MotionSensor_Smart display_name_pl]] "Smart Motion sensors"),
	entity = "MotionSensor",
	labels = {
	...
	TurnOnDelay = 0,
	StatusTextWorking = T(279862944150, --[[ModItemBuildingCompositeDef MassPrint_MotionSensor_Smart StatusTextWorking]] "<color TextNegative>Detecting threats</color>"),
	StatusTextNotWorking = T(849861950897, --[[ModItemBuildingCompositeDef MassPrint_MotionSensor_Smart StatusTextNotWorking]] "<color TextPositive>No threats are detected</color>"),
