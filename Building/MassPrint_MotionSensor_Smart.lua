...
DefineClass.MassPrint_MotionSensor_Smart = {
	...
	display_name = T(238024042147, --[[ModItemBuildingCompositeDef MassPrint_MotionSensor_Smart display_name]] "Smart Motion sensor"),
	description = T(671800346948, --[[ModItemBuildingCompositeDef MassPrint_MotionSensor_Smart description]] "Adding a built-in CPU, basic AI algorithms and using better building materials to optimize the motion sensor, you get increased range and durability\n\nRange increase: <color TextEmphasis>1.5x</color>\nActivates when there are hostile animals in range."),
	menu_display_name = T(851428077112, --[[ModItemBuildingCompositeDef MassPrint_MotionSensor_Smart menu_display_name]] "Smart Motion Sensor"),
	BuildMenuIcon = "UI/Icons/Build Menu/infrared_detector",
	BuildMenuPos = 99,
	display_name_pl = T(575972933227, --[[ModItemBuildingCompositeDef MassPrint_MotionSensor_Smart display_name_pl]] "Smart Motion sensors"),
	entity = "MotionSensor",
	labels = {
	...
	TurnOnDelay = 0,
	StatusTextWorking = T(425402905197, --[[ModItemBuildingCompositeDef MassPrint_MotionSensor_Smart StatusTextWorking]] "<color TextNegative>Detecting threats</color>"),
	StatusTextNotWorking = T(349484424500, --[[ModItemBuildingCompositeDef MassPrint_MotionSensor_Smart StatusTextNotWorking]] "<color TextPositive>No threats are detected</color>"),
