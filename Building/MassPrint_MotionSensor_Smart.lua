...
DefineClass.MassPrint_MotionSensor_Smart = {
	...
	description = T(540780788651, --[[ModItemBuildingCompositeDef MassPrint_MotionSensor_Smart description]] "Adding a built-in CPU, basic AI algorithms and using better building materials to optimize the motion sensor, you get increased range and durability\n\nRange increase: <color TextEmphasis>1.5x</color>\nActivates when there are hostile animals in range."),
