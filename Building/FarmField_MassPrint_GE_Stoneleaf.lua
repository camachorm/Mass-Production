...
DefineClass.FarmField_MassPrint_GE_Stoneleaf = {
	...
	display_name = T(732767026870, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_Stoneleaf display_name]] "GE Stoneleaf field"),
	menu_display_name = T(518614547020, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_Stoneleaf menu_display_name]] "GE Stoneleaf"),
	BuildMenuIcon = "UI/Icons/Build Menu/Plants/plant_siliconleaf",
	BuildMenuPos = 69,
	display_name_pl = T(425966423874, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_Stoneleaf display_name_pl]] "GE Stoneleaf fields"),
