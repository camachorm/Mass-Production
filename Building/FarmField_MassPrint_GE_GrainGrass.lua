...
DefineClass.FarmField_MassPrint_GE_GrainGrass = {
	...
	display_name = T(347032606646, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_GrainGrass display_name]] "GE Grain grass field"),
	menu_display_name = T(328130792303, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_GrainGrass menu_display_name]] "GE Grain grass"),
	BuildMenuIcon = "UI/Icons/Build Menu/Plants/plant_grain_grass",
	BuildMenuPos = 1,
	display_name_pl = T(822714319612, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_GrainGrass display_name_pl]] "GE Grain grass fields"),
