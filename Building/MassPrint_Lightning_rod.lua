...
DefineClass.MassPrint_Lightning_rod = {
	...
	display_name = T(755083847163, --[[ModItemBuildingCompositeDef MassPrint_Lightning_rod display_name]] "Massive Lightning rod"),
	description = T(182525499519, --[[ModItemBuildingCompositeDef MassPrint_Lightning_rod description]] "Catches nearby lightning strikes in a bigger area. Distributes the absorbed energy to all batteries in the grid."),
	BuildMenuIcon = "UI/Icons/Build Menu/lightning_rod",
	BuildMenuPos = 1000,
	display_name_pl = T(322752840422, --[[ModItemBuildingCompositeDef MassPrint_Lightning_rod display_name_pl]] "Massive Lightning rods"),
