...
DefineClass.MassPrint_Composter_Wood = {
	...
	display_name = T(914092675982, --[[ModItemBuildingCompositeDef MassPrint_Composter_Wood display_name]] "Wood Composter"),
	description = T(551022142559, --[[ModItemBuildingCompositeDef MassPrint_Composter_Wood description]] "Composts food into manure"),
	menu_display_name = T(601090512732, --[[ModItemBuildingCompositeDef MassPrint_Composter_Wood menu_display_name]] "Wood Composter"),
	BuildMenuIcon = "UI/Icons/Build Menu/storage_chest_wood",
	BuildMenuPos = 2,
	display_name_pl = T(435639309842, --[[ModItemBuildingCompositeDef MassPrint_Composter_Wood display_name_pl]] "Composters"),
	display_name_short = T(747505328501, --[[ModItemBuildingCompositeDef MassPrint_Composter_Wood display_name_short]] "Composter"),
	entity = "Chest_01",
	labels = {
		"BerserkTargets",
	},
	...
	TransformDisplayName = T(766613311733, --[[ModItemBuildingCompositeDef MassPrint_Composter_Wood TransformDisplayName]] "Composting"),
	stack_count = 48,
	accepted_res = {
		"FoodRaw",
		"FoodProcessed",
