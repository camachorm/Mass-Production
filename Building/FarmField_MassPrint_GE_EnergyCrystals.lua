...
DefineClass.FarmField_MassPrint_GE_EnergyCrystals = {
	...
	display_name = T(408279888707, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_EnergyCrystals display_name]] "GE Energy Crystals field"),
	menu_display_name = T(363286492123, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_EnergyCrystals menu_display_name]] "GE Energy Crystals"),
	BuildMenuIcon = "UI/Icons/Build Menu/Plants/enegy_crystals",
	BuildMenuPos = 85,
	display_name_pl = T(813809402497, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_EnergyCrystals display_name_pl]] "GE Energy Crystals fields"),
