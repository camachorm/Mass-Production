...
DefineClass.FarmField_MassPrint_GE_EnergyCrystals = {
	...
	display_name = T(316989805944, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_EnergyCrystals display_name]] "GE Energy Crystals field"),
	menu_display_name = T(734245448036, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_EnergyCrystals menu_display_name]] "GE Energy Crystals"),
	BuildMenuIcon = "UI/Icons/Build Menu/Plants/enegy_crystals",
	BuildMenuPos = 85,
	display_name_pl = T(656263156711, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_EnergyCrystals display_name_pl]] "GE Energy Crystals fields"),
