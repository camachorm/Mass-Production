...
DefineClass.MassPrint_Upgraded_Large_Drying_Rack = {
	...
	TransformDisplayName = T(625489267105, --[[ModItemBuildingCompositeDef MassPrint_Upgraded_Large_Drying_Rack TransformDisplayName]] "Drying"),
