...
DefineClass.MassPrint_Upgraded_Large_Drying_Rack = {
	...
	display_name = T(548283990983, --[[ModItemBuildingCompositeDef MassPrint_Upgraded_Large_Drying_Rack display_name]] "Large Electronic drying rack"),
	...
	menu_display_name = T(565845584527, --[[ModItemBuildingCompositeDef MassPrint_Upgraded_Large_Drying_Rack menu_display_name]] "Electronic Drying Rack"),
	BuildMenuIcon = "UI/Icons/Build Menu/production_large_drying_rack_scrap",
	BuildMenuPos = 1,
	display_name_pl = T(796280056216, --[[ModItemBuildingCompositeDef MassPrint_Upgraded_Large_Drying_Rack display_name_pl]] "Large Electronic drying rack"),
	entity = "Skin_Rag_04",
	labels = {
		"BerserkTargets",
	},
