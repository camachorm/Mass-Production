...
DefineClass.MassEquipmentPrinter3D = {
	...
	display_name = T(506283430519, --[[ModItemBuildingCompositeDef MassEquipmentPrinter3D display_name]] "3D Equipment Printer"),
	description = T(999037034628, --[[ModItemBuildingCompositeDef MassEquipmentPrinter3D description]] "Used for production of:\n - <color TextEmphasis>Basic Armor</color><image 'UI/Icons/Items/leather_armor' 1100>\n - <color TextEmphasis>Advanced Armor</color><image 'UI/Icons/Items/synthetic_armor' 1100>\n - <color TextEmphasis>Weapons</color><image 'Mod/H5Xfcfc/Images/download_1_44x44 3.png' 1100>"),
	BuildMenuIcon = "UI/Icons/Build Menu/3d_printer",
	BuildMenuPos = 14,
	display_name_pl = T(586683741839, --[[ModItemBuildingCompositeDef MassEquipmentPrinter3D display_name_pl]] "3D Equipment Printer"),
	entity = "3D_Printer",
	labels = {
		"CPUCoreDevice",
		"BerserkTargets",
