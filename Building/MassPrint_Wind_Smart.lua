...
DefineClass.MassPrint_Wind_Smart = {
	...
	display_name = T(174472785151, --[[ModItemBuildingCompositeDef MassPrint_Wind_Smart display_name]] "Smart Wind turbine"),
	description = T(561043076711, --[[ModItemBuildingCompositeDef MassPrint_Wind_Smart description]] "Adding a built-in CPU, basic AI algorithms and some self-aligning servo-motors to optimize the wind turbine operations giving improved Power Production & Durability.\n\nGenerates <color TextEmphasis>up to 200</color> <image 'UI/Icons/Resources/res_electricity' 1100> depending on wind speed."),
	menu_display_name = T(658010472774, --[[ModItemBuildingCompositeDef MassPrint_Wind_Smart menu_display_name]] "Smart Wind turbine"),
	BuildMenuIcon = "UI/Icons/Build Menu/wind_turbine",
	BuildMenuPos = 11,
	display_name_pl = T(206755240512, --[[ModItemBuildingCompositeDef MassPrint_Wind_Smart display_name_pl]] "Smart Wind turbines"),
	entity = "WindTurbine",
	labels = {
		"PowerSources",
		"BerserkTargets",
