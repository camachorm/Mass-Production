...
DefineClass.FarmField_MassPrint_GE_RedMeat = {
	...
	display_name = T(294587078690, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_RedMeat display_name]] "GE Red Meat field"),
	menu_display_name = T(462356224260, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_RedMeat menu_display_name]] "GE Red Meat"),
	BuildMenuIcon = "UI/Icons/Items/raw_meat",
	BuildMenuPos = 31,
	display_name_pl = T(497086767930, --[[ModItemBuildingCompositeDef FarmField_MassPrint_GE_RedMeat display_name_pl]] "GE Red Meat fields"),
